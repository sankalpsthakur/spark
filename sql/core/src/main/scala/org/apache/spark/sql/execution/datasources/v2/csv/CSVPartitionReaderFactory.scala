...
case class CSVPartitionReaderFactory(
  ...
  override def buildReader(file: PartitionedFile): PartitionReader[InternalRow] = {
    ...
    val actualDataSchema =
      ExprUtils.dropCorruptRecordField(dataSchema, options.columnNameOfCorruptRecord)
    val actualReadDataSchema =
      ExprUtils.dropCorruptRecordField(readDataSchema, options.columnNameOfCorruptRecord)
